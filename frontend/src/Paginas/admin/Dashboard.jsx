...
const Dashboard = () => {
  ...
  const porcentajeUsuariosActivos =
    dashboardData.totalUsuarios > 0
      ? Math.round(
          (dashboardData.usuariosActivos / dashboardData.totalUsuarios) * 100
        )
      : 0;
          ...
          <section className="metrics-cards">
            <div className="metric-card">
              ...
              <div className="metric-content">
                ...
                <span className="metric-value">
                  {dashboardData.totalUsuarios.toLocaleString()}
                </span>
              </div>
            </div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-content">
                ...
                <span className="metric-value">
                  ${dashboardData.ingresosMes.toLocaleString()}
                </span>
              </div>
            </div>
          </section>
          ...
          <section className="progress-section">
            <div className="progress-card">
              ...
              <ProgressBar
                porcentaje={Math.min(
                  100,
                  Math.round((dashboardData.ventasMes / 1000) * 100)
                )}
                color="#e73180"
              ...
              <ProgressBar
                porcentaje={Math.min(
                  100,
                  Math.round((dashboardData.descargas / 5000) * 100)
                )}
                color="#2dbb45"
